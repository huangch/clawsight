#!/usr/bin/env bash
# start-wsinsight.sh — Pull and start the WSInsight MCP Docker container.
#
# Usage:
#   ./start-wsinsight.sh -d /path/to/data [options]
#
# Options:
...
IMAGE="huangchtw/wsinsight:latest"
DATA_DIR=""
GPU_IDS=""
MCP_PORT=8765
CONTAINER_NAME="clawsight-mcp"
MAX_CONCURRENT=""
EXPERIMENTAL=false
...
echo "Starting WSInsight MCP server..."
echo "  Image:     $IMAGE"
...
echo "Wait ~5 seconds, then call wsinsight_connect to verify."
