"""ClawSight — Hermes Agent plugin for WSInsight pathology AI.

Provides 15 tools for managing a WSInsight MCP server in Docker and running
whole-slide image (WSI) analysis pipelines via that server.
