...
export default definePluginEntry({
  ...
  name: "ClawSight",
  description:
    "Docker-orchestrated MCP control for the WSInsight family of " +
  ...
  register(apiIn: unknown): void {
  const api = (apiIn ?? {}) as OpenClawPluginApi;
  ...
  if (typeof registerTool !== "function") {
    ...
    // eslint-disable-next-line no-console
    console.warn(
      "ClawSight: api.registerTool is missing — plugin will not register tools",
    );
    return;
  }
